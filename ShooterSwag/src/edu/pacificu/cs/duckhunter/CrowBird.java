...
/**
* This implements the bird class of the crow. The crow is the second easiest to 
* kill as it has starting health of two. This class inherits from the abstract 
* class BirdMain
*
...
public class CrowBird extends BirdMain
{
  ...
  /**
   * This creates a sprite specifically of the bird type: crow which has a 
   * start health of two and and bird speed movement of five.
   * 
  ...
  * 
  * @return integer that holds the score value of the bird: crow
  */
  ...
  /**
   * Returns the flight speed of the bird, for crows it is five
   * 
